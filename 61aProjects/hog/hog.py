...
def tail_points(opponent_score):
    ...
    if score < 10:
        ...
        while score > 0:
            score -= 10
            tenscounter += 1
        return 2*abs(tenscounter-onescounter) + 1
    # END PROBLEM 2
...
def perfect_square(score):
    if score**0.5 == round(score**0.5):
        return True
    else:
        return False
def next_perfect_square(score):
    squareroot = score ** 0.5
...
def play(strategy0, strategy1, update,
    ...
    while score0 < goal and score1 < goal:
        if who == 0:
            ...
            score0 = update(numrolls0, score0, score1, dice)
            
            who +=1
        elif who == 1:
            numrolls1 = strategy1(score1,score0)
            score1 = update(numrolls1, score1, score0, dice)
...
def is_always_roll(strategy, goal=GOAL):
    ...
    while n > 0:
        hundreddice = make_fair_dice(100)
        score = roll_dice(1,hundreddice)-1
        opscore = roll_dice(1,hundreddice)-1

        numstate = strategy(score,opscore)
        score = roll_dice(1,hundreddice)
        opscore = roll_dice(1,hundreddice)
        numstate1 = strategy(score,opscore)
        
        if numstate == numstate1:
...
def make_averaged(original_function, total_samples=1000):
    ...
    def somefunc(*arg):
        ...
        samps = total_samples
        while samps > 0:
            totalsum = totalsum + original_function(*arg)
            samps -= 1
        return totalsum/total_samples
    return somefunc
...
def max_scoring_num_rolls(dice=six_sided, total_samples=1000):
    ...
    while counter < 10:
        counter += 1
        somelist.append(averaged_dice(counter,dice))
    
    return somelist.index(max(somelist)) + 1
    # END PROBLEM 9
...
def square_strategy(score, opponent_score, threshold=12, num_rolls=6):
    ...
    # BEGIN PROBLEM 11
    newscore = square_update(0, score, opponent_score)
...
def final_strategy(score, opponent_score):
    ...
    Anything for a higher win percantage than the square strat
    """
    # BEGIN PROBLEM 12
    ...
    if score >= 97:
        return 1
    elif tail_points(opponent_score) > 8:
        return tail_strategy(score, opponent_score, threshold=8,num_rolls=4)
    elif score > 90 and opponent_score>90:
        return tail_points(opponent_score)
    else:
        return 6
    # END PROBLEM 12
